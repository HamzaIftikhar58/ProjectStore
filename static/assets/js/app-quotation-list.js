...
$(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
      ajax: '/quotation_list_api/',// assetsPath + 'json/invoice-list.json', // JSON file to add data
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 2,
          render: function (data, type, full, meta) {
            var $invoice_id = full['quotation_number'];
            // Creates full output for row
            var $row_output = '<a href="/quotation-preview/'+ full['quotation_number'] +'">#' + $invoice_id + '</a>';
            return $row_output;
          }
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $invoice_status = full['status'],
  ...
  + '<button class="btn btn-icon btn-text-secondary waves-effect waves-light rounded-pill" '
      ...
      + 'data-quotation-id="' + full['quotation_number'] + '" title="Delete">'
      + '<i class="ti ti-trash mx-2 ti-md"></i></button>'
  + '<a href="/quotation-preview/' + full['quotation_number'] + '" '
  ...
  + '<div class="dropdown">'
      ...
      + '<div class="dropdown-menu dropdown-menu-end">'
          ...
          + '<a href="/edit-quotation/' + full['quotation_number'] + '/" class="dropdown-item">Edit</a>'
      + '</div>'
  + '</div>'
  + '</div>'
);
      ...
      buttons: [
      {
  text: '<i class="ti ti-plus ti-xs me-md-2"></i><span class="d-md-inline-block d-none mx-2">Create Quotation</span>',
  className: 'btn btn-primary waves-effect waves-light',
  action: function (e, dt, button, config) {
    window.location = addQuotationUrl;
  }
},
{
  text: '<i class="ti ti-download ti-xs me-md-2"></i><span class="d-md-inline-block d-none">Download Quotation</span>',
