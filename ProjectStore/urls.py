...
urlpatterns = [
   ...
   path('reset/<uidb64>/<token>/', views.CustomPasswordResetConfirmView.as_view(  
    ...
    #   path("product_Show Mores",views.product_Show Mores,name="product_Show Mores"),
      ...
      path("hardwarepage/",views.hardwarepage,name="hardwarepage"),
      path("softwarepage/",views.softwarepage,name="softwarepage"),
      path("Robotspage/",views.Robotspage,name="Robotspage"),
    ...
    path('contact/success/', views.contact_success, name='contact_success'),
      ...
      path("Electronicspage/",views.Electronicspage,name="Electronicspage"), 
